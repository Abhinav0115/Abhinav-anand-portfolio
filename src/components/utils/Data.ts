...
export const WorkExperienceData: IWorkExperienceData[] = [
    {
        ...
        description:
            "As a Fullstack Developer, I collaborated closely with both frontend and backend teams to design, develop, and integrate components and APIs. I worked primarily with the MERN stack (MongoDB, Express, React, Node.js) and Next.js to build scalable, efficient web applications, improving both client-facing and internal tools.",
        keyResponsibilities: [
...
export const projectCard: IProjectSectionCardData[] = [
    ...
    },
    {
        ...
        url: "https://file-sharing-app-su3e.onrender.com/",
        description:
